...
MySQL - 5.5.5-10.4.28-MariaDB : Database - biblioteca
*********************************************************************
*/
...
insert  into `autor`(`id_aut`,`nombre`,`fech_nac`,`Nac`,`descrip`) values (1,'Gabriel García Márquez','1927-03-06','Colombia','Ganador del Premio Nobel de Literatura'),(2,'J.K. Rowling','1965-07-31','Reino Unido','Autora de la serie de Harry Potter'),(3,'Haruki Murakami','1949-01-12','Japón','Autor de \"Tokio blues\" y \"1Q84\"'),(4,'Chimamanda Ngozi Adichie','1977-09-15','Nigeria','Escritora feminista y autora de \"Americanah\"'),(5,'George Orwell','1903-06-25','Reino Unido','Autor de \"1984\" y \"Rebelión en la granja\"'),(6,'Isabel Allende','1942-08-02','Chile','Autora de \"La casa de los espíritus\" y otros');
...
insert  into `prestamos`(`id_prest`,`codigo`,`fechini`,`fechfin`,`id_lib`,`id_est`,`id_per`) values (1,'pres-01','2023-08-01','2023-08-15',1,1,1),(2,'pres-02','2023-07-15','2023-07-30',2,2,2),(3,'pres-03','2023-06-01','2023-06-15',3,3,3),(4,'pres-04','2023-05-10','2023-05-25',4,4,4),(5,'pres-05','2023-04-05','2023-04-20',5,5,5),(6,'pres-06','2023-03-15','2023-03-30',6,6,6),(7,'pres-07','2023-08-17','2023-08-20',8,9,11),(8,'pres-08','2023-08-10','2023-08-20',9,11,12);
