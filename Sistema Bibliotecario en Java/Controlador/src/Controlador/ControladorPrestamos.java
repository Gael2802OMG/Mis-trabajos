...
public class ControladorPrestamos implements ActionListener{
        ...
        if(e.getSource()==vista.btnNuevoPre){
                ...
                if(act!=true){
                    try {
                        ...
                        if(!mod.getCodigo().equals("")){
                            ...
                            mod.setIdEst(Integer.parseInt(vista.cmbIdEst.getSelectedItem().toString()));
                            mod.setIdPer(Integer.parseInt(vista.cmbIdPers.getSelectedItem().toString()));
                            mod.setIdLib(Integer.parseInt(vista.cmbLibrospres.getSelectedItem().toString()));
                            fechaini();
                            fechafin();
                            db.insertar(mod);
                            limpiar();
            ...
            if(valiEmptyBusc()!=true){
               ...
               try {
                    ...
                    vista.cmbIdEst.setSelectedItem(String.valueOf(mod.getIdEst()));
                    vista.cmbIdPers.setSelectedItem(String.valueOf(mod.getIdPer()));
                    vista.cmbLibrospres.setSelectedItem(String.valueOf(mod.getIdLib()));
    ...
    public void limpiar(){
        ...
        vista.jdFechaini.setDate(null);
        vista.jdFechaFi.setDate(null);
    }
