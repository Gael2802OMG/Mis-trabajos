...
public class ControladorDevoluciones implements ActionListener{
    ...
    public ControladorDevoluciones(Devoluciones mod, Prestamos mod2, dbDevoluciones db, dbPrestamos db2, dlg_Devoluciones vista, dlg_Menu vista2) {
        ...
        vista.btnDevolverdevo.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()==vista.btnNuevodevo){
            ...
            vista.txtIDPrestamodevo.setEnabled(hab);
            ...
            vista.btnDevolverdevo.setEnabled(hab);
            ...
            if(valiEmpty()!=true){
                ...
                try {
                    mod2 = (Prestamos)db2.buscar(Integer.parseInt(vista.txtIDPrestamodevo.getText()));
                    if(mod2.getCodigo().equals("")){
                        JOptionPane.showMessageDialog(vista,"Porfavor asegurese de ingresar un id de prestamo existente y que no esté usado");
                    }
                    else{
                        if (act != true) {
                            try {
                                ...
                                if (!mod.getCodigo().equals("")) {
                                    ...
                                    mod.setId_dpres(Integer.parseInt(vista.txtIDPrestamodevo.getText()));
                            ...
                            try {
                                mod.setCodigo(vista.txtCodigoDevolucion.getText());
                                mod.setCostdia(Integer.parseInt(vista.txtCostodevo.getText()));
            ...
            if(valiEmptyBusc()!=true){
                ...
                try {
                    ...
                    if(mod.getCodigo().equals("")){
                        ...
                        vista.txtIDPrestamodevo.setText(String.valueOf(mod.getId_dpres()));
    ...
    public void limpiar(){
            ...
            vista.txtIDPrestamodevo.setText("");
    ...
    public boolean valiEmpty(){
        if(!vista.txtCodigoDevolucion.getText().isEmpty()
                ...
                && !vista.txtIDPrestamodevo.getText().isEmpty()
