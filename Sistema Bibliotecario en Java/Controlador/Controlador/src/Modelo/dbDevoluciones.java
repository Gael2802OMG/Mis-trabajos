...
public class dbDevoluciones extends dbManejador implements dbPersistencia {
    ...
    public void insertar(Object objecto) throws Exception {
        ...
        String consulta = "INSERT INTO biblioteca.devoluciones(codigo, id_dpres, fechadev, costodia, subtotal, diasderetra, iva) VALUES (?, ?, ?, ?, ?, ?, ?);";
        if (this.conectar()) {
            try {
        ...
        if (this.conectar()) {
            try {
                ...
                if (this.Registros.next()) {
                    ...
                    dev.setId_dpres(this.Registros.getInt("id_dpres"));
    ...
    public float getNuevoAdeudo() throws SQLException {
        // Lógica para calcular el nuevo adeudo utilizando una consulta SQL
        float nuevoAdeudo = 0;
        ...
        if (this.conectar()) {
            try {
                ...
                if (this.Registros.next()) {
                    ...
                    float costoDevolucion = calcularCostoDevolucion(); // Calcula el costo de la devolución
